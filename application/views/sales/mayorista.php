<section class="content">
  <div class="row" >
    <div class="col-xs-12">
      <div class="box" style="background-color: #dd4b39">
        <div class="box-header">
          <h3 class="box-title" ><strong>Nueva Venta Mayorista <i class="fa fa-fw fa-truck"></i></strong></h3>
          <i class="fa fa-fw fa-close text-black pull-right"  onclick="cargarView('dash', 'accesosdirectos', '')" style="cursor: pointer"></i>
        </div><!-- /.box-header -->
        <div class="box-body">
        	<div class="row">
