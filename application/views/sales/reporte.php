<section class="content">
    <div class="row">
        <div class="col-xs-12">
            <h3 class="box-title">Consulta Comprobantes de Ventas</h3>
...
$('#btnConsultar').click(function(){
  ...
  $.ajax({
        ...
        url: 'index.php/sale/getComprobantes', 
        success: function(result){
                    if(result != false){
                        var data = [];
                        data.push(['Orden','Importe', 'Medio', 'Caja', 'Fecha']);
                        $.each(result,function(index,item){
                          data.push([item.oId, item.rcbImporte, item.medDescripcion, item.cajaId, item.rcbFecha]);
                        });
                        ...
                        anchor.href = url;
                        anchor.download = "archivo ventas.xlsx";
                        anchor.click();
