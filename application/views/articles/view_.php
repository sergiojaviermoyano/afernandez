  ...
  <div class="form-horizontal">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-2">
		...
		<div class="form-group">
			<label class="col-sm-4"> Margen Minorista  <strong style="color: #dd4b39">*</strong>:   </label>
			<div class="col-sm-2">
    ...
    <div class="form-group">
			<label class="col-sm-4"> Cotización Dolar</label>
      <label class="col-sm-4"> Precio Venta Minorista:  </label>
			<label class="col-sm-4"> Precio Venta Mayorista:  </label>
    </div>
        ...
        <input type="text" id="cotizacionDolar" class="form-control has-success" value="<?php echo $data['cotizacionDolar'];?>" disabled="disabled">
			...
			<div class="col-sm-4">
        <strong id="pventaMinorista">0.00</strong>
      </div>
      <div class="col-sm-4">
